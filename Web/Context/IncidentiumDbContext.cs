...
namespace IncidentsHandler.Data.Context
{
    public class IncidentsHandlerDbContext : DbContext
    {
        public IncidentsHandlerDbContext(DbContextOptions<IncidentsHandlerDbContext> options) : base(options)
        {
